...
while($row = mysql_fetch_row($rs)){
	if($row[3] == $_SESSION["studID"]){
		...
		$uncompressedMajor = $COMMON->uncompressMajor($row[5]);
      ...
      <div id="form">
			...
			<div class="field">
				  ...
				  <select id="major" name = "major">
					...
					<option <?php if($major == 'Engineering Undecided'){echo("selected");}?>>Engineering Undecided</option>
<!-- someday
